...
export default class ChangeTransactionPassword extends Component {
    state={
            ...
            <KeyboardAvoidingView>
                <View style={{alignItems:'center'}}>
                    <List style={[styles.FormLayer]}>
                        ...
                        <Rinput  label={'确认新密码'} placeholder={'请确认新交易密码'} ></Rinput>
                        <Rinput  label={'邮箱验证码'}  placeholder={'请输入验证码'}RightItem={<CountDownBtn text={'点击获取'} ></CountDownBtn>} ></Rinput>
                    </List>
